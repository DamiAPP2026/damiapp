    ...
    return (
      <div style={{
        ...
        <div style={{textAlign:'center'}}>
          ...
          <div style={{fontSize:'14px', color:'#7c8088'}}>Caricamento diari...</div>
        </div>
      </div>
    )
  }
      ...
      <style>{`
        *{box-sizing:border-box;}
        ...
        .cal-day{aspect-ratio:1;display:flex;align-items:center;justify-content:center;
          border-radius:8px;font-size:12px;font-weight:600;color:#7c8088;background:#f3f4f7;}
      ...
      <div className="diario-wrap">
        ...
        <div style={{padding:'12px'}}>
          ...
          <div style={{background:'#feffff', borderRadius:'18px', padding:'14px', marginBottom:'10px', boxShadow:sh}}>
            ...
            {crisiMese.length === 0 && (
              <div style={{textAlign:'center', padding:'12px', color:'#bec1cc', fontSize:'12px'}}>
                Nessuna crisi in {mesiNomi[mese.getMonth()]}
              </div>
            )}
          </div>
            ...
            {crisi.length === 0 ? (
              <div style={{textAlign:'center', padding:'24px', color:'#bec1cc'}}>
                ...
                <div style={{fontSize:'11px', marginTop:'4px'}}>
                  Le crisi registrate appariranno qui
                </div>
              </div>
            ) : (
