        ...
        <div style={{background:'linear-gradient(135deg,#08184c,#193f9e)',padding:'16px 16px 20px'}}>
          <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:'12px'}}>
            <div>
              ...
              <div style={{fontSize:f(11),color:'rgba(255,255,255,0.7)',marginTop:'2px'}}>
                Dr. {tokenData.medicoName} — Sola lettura
              </div>
            </div>
            <button onClick={onLogout} style={{display:'flex',alignItems:'center',gap:'6px',padding:'8px 14px',borderRadius:'20px',border:'none',background:'rgba(255,255,255,0.15)',color:'#fff',fontSize:f(12),fontWeight:'700',cursor:'pointer'}}>
