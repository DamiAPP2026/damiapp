  ...
  return (
    <div style={{
      ...
      <div style={{padding:'12px 12px 0'}}>
        <div style={{background:'#feffff', borderRadius:'22px', padding:'18px 18px 16px', boxShadow:sh}}>
          ...
          <div style={{display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'12px'}}>
            <div style={{display:'flex', alignItems:'center', gap:'8px'}}>
              ...
              <span style={{fontSize:'14px', fontWeight:'800', color:'#0d2055'}}>DamiAPP</span>
            </div>
            <div style={{textAlign:'right'}}>
              <div style={{
                fontSize:'17px', fontWeight:'900', color:'#02153f',
                letterSpacing:'1px', fontVariantNumeric:'tabular-nums', lineHeight:1
              }}>{timeStr}</div>
              <div style={{fontSize:'9px', color:'#bec1cc', fontWeight:'600', marginTop:'2px'}}>{dataStr}</div>
            </div>
          </div>

          {/* Saluto */}
          <div style={{
            fontSize:'26px', fontWeight:'900', color:'#02153f',
            letterSpacing:'-0.5px', marginBottom:'4px'
          }}>
            Ciao {nomeUtente || 'Damiano'}!
          </div>
          <div style={{
            fontSize:'12px', color:'#bec1cc', marginBottom:'18px',
          ...
          <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'10px'}}>
            ...
            <button onClick={startTimer} style={{
              ...
              <div style={{
                ...
                gap:'6px', color:'#fff', fontSize:'12px', fontWeight:'800'
              }}>
      ...
      <div style={{
        ...
        {[
          {Icon:AlertTriangle, ibg:'linear-gradient(135deg,#F7295A,#FF9F3F)',
           ish:'rgba(247,41,90,0.28)', label:'Ultima crisi',
           val:'26g', sub:'al 20/03', bar:'linear-gradient(90deg,#F7295A,#FF8C42)'},
          {Icon:Clock, ibg:'linear-gradient(135deg,#00BFA6,#2e84e9)',
           ish:'rgba(0,191,166,0.28)', label:'Prossima terapia',
           val:'20:00', sub:'Keppra', bar:'linear-gradient(90deg,#00BFA6,#2e84e9)'},
          {Icon:Bell, ibg:'linear-gradient(135deg,#FFD93D,#FF8C42)',
           ish:'rgba(255,140,66,0.28)', label:'Scadenze',
           val:'2', sub:'entro 30g', bar:'linear-gradient(90deg,#FFD93D,#FF8C42)'},
          ...
          <div key={i} style={{
            ...
            <div style={{padding:'10px 8px 7px'}}>
              ...
              <div style={{fontSize:'17px', fontWeight:'900', color:'#02153f', lineHeight:1}}>{val}</div>
      ...
      <div style={{padding:'0 12px', marginBottom:'12px'}}>
        <div style={{
          ...
          <span style={{fontSize:'15px', fontWeight:'800', color:'#02153f'}}>
            "Priorità rapide"
          </span>
      ...
      <div style={{padding:'0 12px', marginBottom:'12px'}}>
        <div style={{
          fontSize:'15px', fontWeight:'800', color:'#02153f', marginBottom:'10px'
        }}>
          "Dashboard"
        </div>
      ...
      <div style={{padding:'0 12px'}}>
        <div style={{background:'#feffff', borderRadius:'20px', padding:'18px 16px', boxShadow:sh}}>
          <div style={{fontSize:'15px', fontWeight:'800', color:'#02153f', marginBottom:'8px'}}>
            ⏱ Registrazione crisi
          </div>
          <div style={{
